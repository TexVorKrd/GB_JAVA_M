...
public class Main {
    public static void main(String[] args) {
        ...
        workerList.add(new Frilancer(1998,"Василий","Пупкин","1223",15));
        workerList.add(new Frilancer(1996,"Сергей","Петров","1223",16));
        workerList.add(new Frilancer(1978,"Виталий","Иванов","1223",20));
